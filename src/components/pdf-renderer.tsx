...
const PdfRenderer = ({ url }: PdfRendererProps) => {
  ...
  const [rendererScale, setRendererScale] = useState<number | null>(null);

  const isLoading = rendererScale !== scale;
          ...
          <div ref={ref}>
            ...
            >
              ...
              <Page
                ...
                onRenderSuccess={() => setRendererScale(scale)}
              />
            </Document>
          </div>
        </SimpleBar>
